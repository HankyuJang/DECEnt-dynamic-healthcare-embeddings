...
Process node2vec, deepwalk embedding
"""
...
if __name__ == "__main__":
    ...
    method_list = ["deepwalk", "node2vec_BFS", "node2vec_DFS"]
    for method in method_list:

        print("Procedding {} embeddings...".format(method))
        learned_emb_list = []
        for t in range(min_timestamp, max_timestamp+1):
            filename = "~/network_embedding/snap/examples/node2vec/{}_emb/day{}.emb".format(method, t)
